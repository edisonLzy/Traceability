...
export function SourceLocation({ location }: { location: NonNullable<Issue['metadata']['source']> }) {
  return (
    <div className="border-b border-hairline bg-surface-2">
      ...
      {location.context && (
        <pre className={cn('m-0 overflow-auto bg-[#090a0b] px-5 py-4.5 font-mono text-xs leading-7 text-[#c7cbd3]', 'max-h-50 border-y border-hairline')}>
