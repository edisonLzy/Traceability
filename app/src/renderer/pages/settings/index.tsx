  ...
  return (
    <div className="mx-auto block min-h-full max-w-[1440px] px-4 pt-5.5 pb-15 tablet:px-8 tablet:pt-7">
      <div className="mb-7 flex items-start justify-between gap-3.5">
        <div>
          <h1 className="m-0 text-2xl leading-tight font-semibold tracking-[-0.7px] tablet:text-[28px]">SDK setup</h1>
          <p className="mt-1.5 text-subtle">Connect a web, React, Electron or Module Federation application.</p>
        </div>
      </div>
